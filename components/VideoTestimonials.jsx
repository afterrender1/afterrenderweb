...
const VideoCard = ({ src, title, number }) => {
  return (
    <div className="relative group h-full flex flex-col items-center">
      ...
      {/* Card */}
      <div className="relative bg-white/5 rounded-3xl p-8 border border-gray-800/50 h-full overflow-hidden flex flex-col justify-between transition-all duration-500 transform hover:scale-[1.03] mt-8 w-full">
        {/* Background */}
        <div
        ...
        {/* Title */}
        <h3
          className="relative z-10 text-white text-2xl font-semibold text-center mt-8"
...
const VideoTestimonials = () => {
  return (
    <div className="relative min-h-screen bg-black py-28 px-4 overflow-hidden">
      {/* Background */}
      <div
      ...
      {/* Cards Grid */}
      <div className="relative z-10 mx-30 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-16 px-4 sm:px-10 md:px-20 lg:px-30">
        {videos.map((video, i) => (
          <VideoCard
            key={i}
            src={video.src}
