...
const TeamMemberCard = ({ image, name, title, socials }) => {
  ...
  return (
    <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-6 border border-gray-800 transition-all duration-300 group">
      <div className="mb-6">
...
const MeetOurTeam = () => {
  const teamMembers = [
    ...
    },
    {
      ...
      name: "Dane McBeth",
      title: "Director of Client Acquisition",
      socials: [
        { platform: "instagram", url: "#" },
        { platform: "linkedin", url: "#" }
      ]
  ...
  return (
    <div className="relative min-h-screen bg-black py-20 px-4 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-100 w-96 h-96 bg-[#1b3552] rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 right-100 w-96 h-96 bg-[#1d3044] rounded-full blur-3xl pointer-events-none" />
    </div>
  );
};
